...
config :rocdev,
  ...
  slack_invite_base_url: System.get_env("SLACK_INVITE_API_BASE") || "${SLACK_INVITE_API_BASE}",
  slack_invite_api_token: System.get_env("SLACK_INVITE_API_TOKEN") || "${SLACK_INVITE_API_TOKEN}"
